 ...
 * @subpackage Ced_Tiktok_Integration_By_CedCommerce/admin/partials
 */
...
if ( is_array( $active_marketplaces ) && ! empty( $active_marketplaces ) ) {
	...
	<div class="ced-marketplaces-heading-main-wrapper">
		<div class="ced-marketplaces-heading-wrapper">
			<h2><?php esc_html_e( 'Active Marketplaces', 'cedcommerce-connector-for-tiktok-shop' ); ?></h2>
		</div>
	</div>
		...
		foreach ( $active_marketplaces as $key => $value ) {
			...
			<div class="ced-marketplace-card <?php echo esc_attr( $value['name'] ); ?>">
				<a href="<?php echo esc_attr( $url ); ?>">
					<div class="thumbnail">
						<div class="thumb-img p-10">
							<img class="img-responsive center-block integration-icons" src="<?php echo esc_attr( $value['card_image_link'] ); ?>" width="100%" alt="how to sell on Tiktok marketplace">
						</div>
					</div>
